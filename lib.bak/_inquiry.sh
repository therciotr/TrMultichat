...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Tr Multichat, Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [1] Instalar Tr Multichat \n"
  printf "   [1] Atualizar Tr Multichat \n"
  printf "   [2] Deletar Tr Multichat \n"
  printf "   [3] Bloquear Tr Multichat \n"
  printf "   [4] Desbloquear Tr Multichat \n"
  printf "   [5] Alter. dominio Tr Multichat \n"
  printf "\n"
  read -p "> " option
