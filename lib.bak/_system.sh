...
system_mv_folder() {
  print_banner
  printf "${WHITE} 💻 Fazendo download do código Tr Multichat...${GRAY_LIGHT}"
  printf "\n\n"
  ...
  sudo su - root <<EOF
  cp "${PROJECT_ROOT}"/trmultichat.zip /home/deploy/${instancia_add}/
EOF
...
system_unzip_trmultichat() {
  print_banner
  printf "${WHITE} 💻 Fazendo unzip Tr Multichat...${GRAY_LIGHT}"
  printf "\n\n"

  sleep 2

  sudo su - deploy <<EOF
  unzip /home/deploy/${instancia_add}/trmultichat.zip -d /home/deploy/${instancia_add}
EOF
...
system_update() {
  print_banner
  printf "${WHITE} 💻 Vamos atualizar o sistema Tr Multichat...${GRAY_LIGHT}"
  printf "\n\n"
...
deletar_tudo() {
  print_banner
  printf "${WHITE} 💻 Vamos deletar o Tr Multichat...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_bloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos bloquear o Tr Multichat...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_desbloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos Desbloquear o Tr Multichat...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_dominio() {
  print_banner
  printf "${WHITE} 💻 Vamos Alterar os Dominios do Tr Multichat...${GRAY_LIGHT}"
  printf "\n\n"
