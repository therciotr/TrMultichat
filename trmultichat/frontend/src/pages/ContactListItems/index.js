        ...
        <Grid style={{ width: "99.6%" }} container>
          ...
          <Grid xs={12} sm={7} item>
            <Grid spacing={2} container>
              ...
              <Grid xs={4} sm={2} item>
                <TrButton fullWidth onClick={goToContactLists}>
              ...
              <Grid xs={4} sm={2} item>
                <TrButton fullWidth onClick={handleOpenContactListItemModal}>
        ...
        <Table size="small">
          <TableHead style={{ backgroundColor: 'rgba(11, 76, 70, 0.06)' }}>
            <TableRow>
              ...
              <TableCell style={{ color: 'var(--tr-primary)', fontWeight: 600 }}>{i18n.t("contactListItems.table.name")}</TableCell>
