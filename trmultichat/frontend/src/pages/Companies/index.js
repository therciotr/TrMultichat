...
import { TrButton, TrCard, TrSectionTitle } from "../../components/ui";
...
const FormCompany = () => {
			...
			return <>
				<Grid item>
					<TextField
						...
						helperText="Token de API para integrações (opcional)"
						name="token"
						value={company.token}
						onChange={handleChangeInput}
						autoComplete="token"
	...
	return (
		<Container component="main" maxWidth="sm" className="tr-card-border" style={{ borderRadius: "var(--tr-radius)" }}>
			<CssBaseline />
			<div className={classes.paper}>
				<TrSectionTitle
					title={i18n.t("companies.title")}
					subtitle="Defina plano, nome e (opcional) token para integrações"
					icon={<StoreIcon />}
				/>
				<TrCard elevation={1}>
					<form className={classes.form} noValidate onSubmit={handlSubmit} style={{ padding: 16 }}>
