        ...
        <Table size="small">
          <TableHead style={{ backgroundColor: 'rgba(11, 76, 70, 0.06)' }}>
            <TableRow>
              ...
              <TableCell align="center" style={{ color: 'var(--tr-primary)', fontWeight: 600 }}>{i18n.t("queueIntegration.table.id")}</TableCell>
              <TableCell align="center" style={{ color: 'var(--tr-primary)', fontWeight: 600 }}>{i18n.t("queueIntegration.table.name")}</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            <>
